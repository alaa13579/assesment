...
if (isset($_POST['btn_add_quiz_sub']))
 {
	extract($_POST);
	$query="insert into category (cat_name) VALUES ('','$course_name')";
...
$query="insert into question_test (question, opt1, opt2, opt3, opt4, matchedanswer, course_id) VALUES ('$ques','$option1','$option2','$option3','$option4','$matchedanswer','$cour')"; 
